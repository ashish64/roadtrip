                        ...
                        <div class="mt-4">
                            ...
                            <div class="flex flex-col gap-y-3 mt-3">
                                ...
                                @class([
                                    ...
                                    'p-2 flex gap-2 border-green-500 border rounded bg-green-100 hover:bg-green-300 font-bold shadow-lg  shadow-green-500/50' => $suggestion->status == 'approved',
                                    'p-2 flex gap-2 border-red-500 border rounded bg-red-50  font-italic line-through opacity-50 shadow-lg  shadow-red-500/50' => $suggestion->status == 'rejected'
                                ])
                                 >
{{--                                 <div class="p-2  flex gap-2 border-green-500 border rounded bg-green-50 hover:bg-green-300 font-bold shadow-lg  shadow-green-500/50">--}}
{{--                                 <div class="p-2 flex gap-2 border-red-500 border rounded bg-red-50 hover:bg-red-300  font-italic line-through opacity-50 shadow-lg  shadow-red-500/50">--}}
